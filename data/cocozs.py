...
def load_data(root, batch_size, num_workers,zero_shot_classes):
    ...
    database4zero_shot_dataset = COCO(
        root,
        'database_img.txt',
        'database_label_onehot.txt',
        zs = True,
...
class COCO(Dataset):
    ...
    """
    def __init__(self, root, img_txt, label_txt,zs,drop = False, transform=None,zero_shot_classes=35):
        self.root = root
        ...
        class4train = 80-zero_shot_classes
